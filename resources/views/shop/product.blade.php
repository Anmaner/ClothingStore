@extends('layouts.main', ['title' => 'Products', 'headerClass' => 'header-v4'])
		...
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				<a href="{{ route('shopping') }}">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 {{ is_null($catTitle) ? 'how-active1':'' }}">
						All Products
					</button>
				</a>
				@foreach($categories as $cat)
				<a href="{{ route('shopping', $cat->title) }}">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 {{$cat->title==$catTitle?'how-active1':''}}">
						{{ $cat->title }}
					</button>
				</a>
				@endforeach
				...
				<div class="block2">
					...
					<div class="block2-txt flex-w flex-t p-t-14">
						<div class="block2-txt-child1 flex-col-l ">
							<a href="{{route('product',$prod->alias)}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								{{ $prod->title }}
							</a>
